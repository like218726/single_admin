...
class WechatAppPay{
    const WX_APP_ID  = "wx16354ece90394fba";
    const WX_MCH_ID  = "1505077051";
    const WX_APP_SECRET = "ad303e19aa29475d61a2689b08930497";
    ...
    function createXml()
    {
        $this->parameters["appid"] = self::WX_APP_ID;//公众账号ID
        $this->parameters["mch_id"] = self::WX_MCH_ID;//商户号
