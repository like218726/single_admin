<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"E:\www\jitu\public/../application/admin\view\Log\index.html";i:1556011413;s:51:"E:\www\jitu\application\admin\view\Public\base.html";i:1554800809;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
            <form class="layui-form" id="form-admin-add" action="">
                ...
                <div class="layui-inline">
                    <button type="reset" class="layui-btn layui-btn-danger" id="batch_delete" data-url="<?php echo url('batchDelete'); ?>" onclick="batchDelete()">批量删除</button>
                </div>
            </div>
            </form>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#create_time').daterangepicker({
                ...
                showDropdowns: true,
                minDate:'2019-01-01',
                maxDate:moment().add("<?php echo config('daterangepicker_days'); ?>",'days'),
                        ...
                        },
                        {
                            ...
                            "render":function(data, type, row){
                                ...
                                returnStr += '<span class="layui-btn layui-btn-small layui-btn-danger confirm" ' +
                                    'data-id="' + row.id +'" data-info="你确定删除当前日志么？" data-url="<?php echo url('del'); ?>"><i class="layui-icon">&#xe640;</i></span>';
                                return returnStr;
                            }
                        }
                    ],
